...
define("DB_USER", "Time-Tracker");
define("DB_PASS", "Time-Tracker");
define("DB_NAME", "Time-Tracker");

// define personal details for things such as the error email script
define("PERS_NAME", "John Evans");
define("PERS_EMAIL", "john@grandadevans.com");
...
define("LOCAL_TLD", "loc");

// The remote TLD
define("REMOTE_TLD", "com");

// Finally the domain name itself
define("DOMAIN", "Time-Tracker");
...
// Throws a error 330 ERR_CONTENT_DECODING_FAILED
